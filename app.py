...
#             # Format the SQL query with the dynamic values
...
#         # Read the SQL template from file
#         sql_template = read_sql_file("query/fetch_contact.sql")
...
#         # Read the SQL template from file
#         sql_template = read_sql_file("query/fetch_address.sql")
...
#         # Read the SQL template from file
#         sql_template = read_sql_file("query/fetch_dar.sql")
